      ...
      <div className="flex justify-center md:w-[630px] md:h-[630px] w-full">
        <div className="w-full max-w-[415px] flex flex-col gap-[25px]">
          ...
          <div className="flex flex-col sm:flex-row gap-[20px] mx-auto sm:mx-0">
            <button className="w-[300px] md:w-[200px] h-auto md:h-[40px] px-[20px]  py-[10px] rounded-full text-[#fff] text-[12px]  bg-Primary hover:bg-HoverColor tracking-[3%] font-normal">
              PRENDRE RENDEZ-VOUS
            </button>
            <button className="w-[300px] md:w-[200px] h-auto md:h-[40px] px-[10px] py-[10px] rounded-full text-[12px]  border border-Primary border-x-2 border-y-2 text-Primary tracking-[3%]  font-normal hover:text-HoverColor hover:border-HoverColor">
