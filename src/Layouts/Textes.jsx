...
const SuggestionBlock = () => {
  return (
    <div className="max-w-full sm:max-w-[350px] text-[#1a1206] font-HelveticaNeue text-[14px] sm:text-[16px] tracking-[3%]">
      {/* Texte principal */}
      <p className="text-[14px] sm:text-[16px] leading-[150%] font-light">
      ...
      {/* Façade recommandée */}
      <p className="font-bold text-[14px] sm:text-[16px] mt-4 tracking-[3%] text-Primary">Façade recommandée</p>
      <ul className="list-none mt-[6px]">
        <li className="text-[14px] sm:text-[16px] flex items-center">
          <span className="mr-2 font-bold text-[16px] sm:text-[18px] tracking-[3%] pb-3 flex items-center">•</span> Easytouch 964 Vert Minéral Ultra-Mat
        </li>
      </ul>

      {/* Plans de travail recommandés */}
      <p className="font-bold text-[14px] sm:text-[16px] mt-4 tracking-[3%] text-Primary">Plans de travail recommandés</p>
      <ul className="list-none mt-1 space-y-1">
        {["366 Noir structuré", "378 Décor béton noir", "330 Décor béton gris"].map((plan, i) => (
          <li key={i} className="text-[14px] sm:text-[16px] flex items-center">
